...
public class AlertDialogFullScreenImageDisplayer extends MyDialog implements android.view.View.OnClickListener {
    ...
    AlertDialogFullScreenImageDisplayer(Activity a,OnImagePreviewCallbackListener listener, ArrayList<Bitmap> bitmaps, int position) {
