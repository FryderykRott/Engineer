...
//        TODO sprawdzanie czy to nowy tag czy stary
    ...
    public void loadBitmapImages(){
        ArrayList<ReceiptImage> receiptImages = Utils.user.getReceiptImages();
        for(ReceiptImage receiptImage: receiptImages){
            if(receiptImage.getReceiptID().equals(receiptUID))
                images_as_bitmap.add(Utils.base64ToBitmap(receiptImage.getBase64Image()));
        }
    }
