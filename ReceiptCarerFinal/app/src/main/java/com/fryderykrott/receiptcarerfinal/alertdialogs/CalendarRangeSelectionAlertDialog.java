...
public class CalendarRangeSelectionAlertDialog extends Dialog implements android.view.View.OnClickListener {
    ...
    public interface OnAlertDialogRangeDateListener {
        public void OnAlertDialogRangeDateListener(Dialog dialog, Calendar fromDate, Calendar toDate);
    }
